...
class b2b_and_b2c_summary_report(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context=None):
        super(b2b_and_b2c_summary_report, self).__init__(cr, uid, name, context=context)
...
class b2b_and_b2c_summary_report_template_id(models.AbstractModel):
    ...
    _wrapped_report_class = b2b_and_b2c_summary_report
